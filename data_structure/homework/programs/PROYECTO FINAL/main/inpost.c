...
void infija_a_posfija(const char *infija, char *posfija) {
    ...
    for (i = 0; i < longitud; i++) {
        ...
        if (isalnum(c)) {
            ...
            *op_ptr = c;
            ...
            /* POP operadores de MAYOR O IGUAL jerarquia */
            while (stack_size(&stack) > 0) {
                char *top_op;
    ...
    printf("+-------------------------------------------------------------------------------------------------+\n");
    color_amarillo();
    printf("|                                RESULTADO FINAL SIN INVERTIR                                    |\n");
    color_normal();
    printf("|-------------------------------------------------------------------------------------------------|\n");
    printf("|                                                                                                 |\n");
    ...
    printf(" |\n");
    printf("|                                                                                                 |\n");
    printf("|   NOTA: En notacion posfija NO es necesario invertir el resultado                              |\n");
    printf("|                                                                                                 |\n");
    printf("+-------------------------------------------------------------------------------------------------+\n");
...
int main(void) {
    ...
    do {
        ...
        printf("\n");
        printf("+-------------------------------------------------------------------------------------------------+\n");
        printf("| ALGORITMO PARA CONVERTIR DE INFIJA A POSFIJA:                                                  |\n");
        printf("+-------------------------------------------------------------------------------------------------|\n");
        printf("|                                                                                                 |\n");
        printf("|  • Se lee de IZQUIERDA A DERECHA (primer elemento primero)                                      |\n");
        printf("|  • La operacion infija se mantiene original                                                    |\n");
        ...
        printf("|                                                                                                 |\n");
        printf("|  NO ES NECESARIO INVERTIR el resultado final                                                   |\n");
        printf("|                                                                                                 |\n");
